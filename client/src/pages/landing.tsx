            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between text-[9px] border-t border-white/5 pt-1.5 mt-0.5">
                  <span className="text-muted-foreground">Stellar {NETWORK_LABEL}:</span>
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground/80 leading-relaxed font-sans">
                        ...
                        They commit the credential hash to the **KrydoCredentials** Soroban smart contract on Stellar {NETWORK_LABEL}, while delivering the plaintext securely to the user's browser.
                      </p>
                    </div>
